...
Этап 5 выполнялся в течение всего периода НИР с 02.03.2026 по 21.06.2026. После подготовки экспериментального стенда и получения результатов письменный отчёт был собран так, чтобы основная часть отражала выполнение этапов 2--4, а приложения содержали вспомогательные материалы. Ключевые интерпретированные результаты --- сравнительная матрица, графики нагрузочных серий, профиль критериев, таблица метрик, evidence trace и рекомендации --- вынесены в основную часть, поскольку на них непосредственно ссылается текст и по ним проводится доказательное сравнение. В приложениях оставлены команды запуска, структура стенда, перечень raw-артефактов и протокол проверки.
